...
$sql_enc=sprintf("select * from detalhes_venda where email='%s'",$_SESSION['email']);
$res_enc=mysqli_query($ligacao,$sql_enc);
?>
<html lang="en">
<!-- Basic -->
        ...
        <div class="container">
            <div class="my-account-page">
                <div class="bottom-box">
                    <div class="row">
                        <?php
                        while($reg_enc=mysqli_fetch_array($res_enc)){
                            $sql_prod=sprintf("select * from venda where id_venda=%d",$reg_enc['id_venda']);
                                ...
                                <div class="account-box">
                                    <div class="service-box">
                                        <div class="service-desc">
                                            <h4><?php echo $reg_enc['nome_prod']; ?></h4>
                                            <ul>
                                                <li> Data: <?php echo $reg_prod['data_venda'] ?> </li>
                                                <li> Preço: <?php echo $reg_enc['preco']; ?> €</li>
                                                <li> Quantidade: <?php echo $reg_enc['quant']; ?> </li>
                                                <li> Morada: <?php echo $reg_prod['morada']; ?> </li>
                                            </ul>
                                        </div>
                                    </div>
                                </div>
