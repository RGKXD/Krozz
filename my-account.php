                ...
                <div class="row">
                        ...
                        <div class="account-box">
                            <div class="service-box">
                                <div class="service-icon">
                                    <a href="encomendas.php"> <i class="fa fa-gift"></i> </a>
                                </div>
                                <div class="service-desc">
                                    <h4>Encomendas</h4>
                                    <p>Ver as suas encomendas</p>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="col-lg-4 col-md-12">
                            <div class="account-box">
                                <div class="service-box">
                                    ...
                                    <div class="service-desc">
                                        <h4>Login </h4>
                                        <p>Fazer o login na sua conta</p>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="account-box">
                                <div class="service-box">
                                    ...
                                    <div class="service-desc">
                                        ...
                                        <p><a href="limpar-session.php">Sair da Conta</a></p>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="col-lg-4 col-md-12">
                        <div class="account-box">
                            <div class="service-box">
                                <div class="service-icon">
                                    <a href="editar-perfil.php"> <i class="fa fa-location-arrow"></i> </a>
                                </div>
                                <div class="service-desc">
                                    <h4>Editar Dados</h4>
                                    <p>Edite ou adicione dados à sua conta</p>
                                </div>
                            </div>
                        </div>
                    </div>
