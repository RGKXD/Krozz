...
$sql_lista=sprintf("select * from contas where block=2 order by nivel desc;");
$res_lista=mysqli_query($ligacao,$sql_lista);

if(isset($_POST['unblock'])){
    $sql_up=sprintf("update contas set block=1 where id=%d",$_POST['id']);
    mysqli_query($ligacao,$sql_up);
    header('location:euser-lista-block.php');
}
?>
<html>
                ...
                <div class="col-lg-10">
                    ...
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active">
                            <strong>Utilizadores Bloqueados</strong>
                        </li>
                    </ol>
                </div>
                <div class="col-lg-2">
                        ...
                        <div class="ibox-content">
                            ...
                            <table class="footable table table-stripped toggle-arrow-tiny" data-page-size="15" id="myTable">
                                ...
                                <tr>
                                    ...
                                    <th data-hide="phone">Bloquear</th>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <?php echo $reg_lista['id']; ?> 
                                    </td> 
                                    <td>
                                       <form method="post">
                                            <input type="submit" class="btn-white btn btn-xs" name="unblock" value="Desbloquear">
                                            <input type="hidden" name="id" value="<?php echo $reg_lista['id']; ?>">
                                        </form>
                                    </td> 
                                    <td class="text-right">
                                        <div class="btn-group">
                                            <a href="euser-edit.php?varid=<?php echo $reg_lista['id']; ?>"><button class="btn-white btn btn-xs">Editar</button></a>
                                        </div>
                                    </td>
                                </tr>
                                    <?php
